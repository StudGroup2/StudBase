namespace WindowsFormsApp1
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.studBaseDataSet = new WindowsFormsApp1.StudBaseDataSet();
            this.студентыBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.студентыTableAdapter = new WindowsFormsApp1.StudBaseDataSetTableAdapters.СтудентыTableAdapter();
            ...
            // bindingSource1
            // 
            this.bindingSource1.DataSource = this.studBaseDataSet;
        ...
        private StudBaseDataSetTableAdapters.СтудентыTableAdapter студентыTableAdapter;
